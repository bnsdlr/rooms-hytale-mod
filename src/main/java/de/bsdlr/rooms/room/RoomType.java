...
import de.bsdlr.rooms.room.block.RoomBlockType;
...
//        , NetworkSerializable<de.rooms.protocol.RoomType>
{
    public static final AssetBuilderCodec<String, RoomType> CODEC = AssetBuilderCodec.builder(
            ...
            .add()
            .appendInherited(new KeyedCodec<>("Sets", new ArrayCodec<>(SetType.CODEC, SetType[]::new)),
                    ((roomType, s) -> roomType.sets = s),
                    (roomType -> roomType.sets),
                    ((roomType, parent) -> roomType.sets = parent.sets)
            )
            .add()
...
//    @Override
//    public de.rooms.protocol.RoomType toPacket() {
//        return null;
//    }
