...
public class RoomTypeAssetMap<K, T extends JsonAssetWithMap<K, RoomTypeAssetMap<K, T>>> extends AssetMapWithIndexes<K, T> {
    ...
    public RoomTypeAssetMap(@Nonnull IntFunction<T[]> arrayProvider, Function<T, String> groupGetter) {
