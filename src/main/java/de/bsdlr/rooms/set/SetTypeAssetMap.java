...
public class SetTypeAssetMap<K, T extends JsonAssetWithMap<K, SetTypeAssetMap<K, T>>> extends AssetMapWithIndexes<K, T> {
    ...
    public SetTypeAssetMap(@Nonnull IntFunction<T[]> arrayProvider, Function<T, String> groupGetter) {
